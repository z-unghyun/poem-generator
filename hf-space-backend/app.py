...
APP_VERSION = "no-template-fallback-2026-07-01-2"
...
def generate(req: GenerateRequest):
    ...
    if req.mode == "experiment":
        ...
        params = {"app_version": APP_VERSION, "request_id": request_id, "mode": "custom_decoding", "validation_status": validation_status, "validation_reason": validation_reason, "experience_boost": round(0.6 + req.experienceDensity * 0.035, 3), "remove_top_n": int(2 + req.languageJump * 0.28), "band_size": int(25 + req.languageJump * 1.35), "topk": EXPERIMENT_TOPK, "max_new_tokens": EXPERIMENT_MAX_NEW_TOKENS, "newline_stop": 7, "temperature": round(0.7 + req.languageJump * 0.012, 3)}
    else:
